...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠻⣿⣿⡄⠈⠻⣿⣿⢿⣛⣩⠤⠒⠉⠁⠀⠀⠀⠀⠀⠉⠒⢤⡀⠉⠁⠀⠀⠀⠀⠀⢀⡿⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠙⢿⣤⣤⠴⠟⠋⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠑⠤⠀⠀⠀⠀⠀⢩⠇⠀⠀⠀
  ____  _____   _____      ______ ____        _    _          _____ _  __
 |  _ \|  __ \ / ____|    |  ____|  _ \      | |  | |   /\   / ____| |/ /
 | |_) | |  | | |   ______| |__  | |_) |_____| |__| |  /  \ | |    | ' / 
 |  _ <| |  | | |  |______|  __| |  _ <______|  __  | / /\ \| |    |  <  
 | |_) | |__| | |____     | |    | |_) |     | |  | |/ ____ \ |____| . \ 
 |____/|_____/ \_____|    |_|    |____/      |_|  |_/_/    \_\_____|_|\_\
    ...
    if args and args.single_password:
        ...
        if args and args.password_list:
            ...
            password_file = input(CliColors.OKBLUE+"[?] 𝙋𝙖𝙨𝙨𝙬𝙤𝙧𝙙 𝙇𝙞𝙨𝙩 𝙁𝙞𝙡𝙚𝙣𝙖𝙢𝙚:<you can use √ password.txt,  √ bd password.txt or /sdcard/yor file name > \t")
    ...
    if args and args.user:
        ...
        user = input(CliColors.OKBLUE+"[?] 𝗘𝗺𝗮𝗶𝗹/𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲/𝗜𝗗/𝗣𝗵𝗼𝗻𝗲: \t")

    print("")
    print(CliColors.OKCYAN+"[*] 𝙋𝙧𝙤𝙘𝙚𝙨𝙨𝙞𝙣𝙜...")
